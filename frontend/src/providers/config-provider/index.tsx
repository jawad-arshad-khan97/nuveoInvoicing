  ...
  const customTheme: ThemeConfig = {
    ...
    components: {
      ...
      Tabs: {
        ...
        inkBarColor: theme.getDesignToken({ algorithm })["blue-8"],
        itemActiveColor: theme.getDesignToken({ algorithm })["blue-8"],
        itemSelectedColor: theme.getDesignToken({ algorithm })["blue-8"],
      },
    },
  };
